...
# FAQ
### How do I use this?
- Preferably you should follow this tutorial [here](https://github.com/MianReplicate/Custom-Flags-Framework/blob/stable/SYNTAX-INFO.md). However if you are too lazy to learn, copy the following line without the quotation marks into the ACCESSORY output. This will use all your installed accessories and assign them to all your flags: "{ACCESSORY:{ALL:{ALLMUTATORS:FLAGS}}:{ALL:{ALLMUTATORS:MESHES}}}"
